...
class TestImposeNeumannBC(JaxTestCase):
    def test_00_homogenious_bc(self):
        ...
        _, normal_derivative = jvp(f_new, [0.], [-1.])
        self.assertIsclose(normal_derivative, 0.)
    ...
    def test_01_2d(self):
        ...
        _, normal_derivative = jvp(f_new, [array([0., 0.5])], [array([-1., 0.])])
        self.assertIsclose(normal_derivative, array([1., 0]))
...
class TestImposeDirichletBC(JaxTestCase):
    ...
    def test_01_2d(self):
        ...
        adf = cube(1.)
        g = lambda x: array([1., 0])
        f_new = model.impose_dirichlet_bc(adf, f, g)
        value = f_new(array([0., 0.5]))
        self.assertIsclose(value, array([1., 0]))
...
class TestImposeIC(JaxTestCase):
    def test_00_impose_ic(self):
        ...
        self.assertIsclose(f_new(20., 0.), 1.)
        self.assertIsclose(f_new(20., 1000.), 0.)
